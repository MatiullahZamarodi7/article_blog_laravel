...
<body>
    ...
    {{-- @if (Auth::user->role = 'admin' || $user->id == $id) --}}
    <div class="profile-card" id="profileCard">
        ...
        <form action="{{ Route('profile.update', $user->id) }}" id="editProfileForm" method="POST"
            ...
            <div class="form-group">
                <label for="fullName"><i class="fas fa-user-circle"></i> در مورد خود </label>
                <div class="input-wrapper">
                    <input type="text" name="about" id="fullName" value="{{ $user->about }}"
                        placeholder="مثلاً مطیع الله زمردی  استم از پروان افغانستان ." value="کاربر نمونه">
                </div>
                @error('about')
                    <div style="color: #ef4444; font-size: 0.95rem; margin-top: 0.25rem;">
                        {{ $message }}
