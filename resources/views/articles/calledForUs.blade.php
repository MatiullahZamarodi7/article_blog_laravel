...
<body>
    ...
    <div class="container">
        <div class="contact-box">
            ...
            <!-- فرم تماس -->
            <form action="{{ Route('called.store') }}" method="POST" id="contactForm" class="contact-form">
                @csrf
                <div class="form-group">
                    <label for="name">نام و نام خانوادگی</label>
                    <input type="text" id="name" value="{{ Auth::user()->name }}" name="name" disabled
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" value="{{ Auth::user()->email }}" name="email" disabled
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="subject" name="title" placeholder="موضوع پیام را وارد کنید" required>
                ...
                <div class="form-group">
                    ...
                    <textarea id="message" name="descriptions" rows="5" placeholder="متن پیام خود را بنویسید..." required></textarea>
