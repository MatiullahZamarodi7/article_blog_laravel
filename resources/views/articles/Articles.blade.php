                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                <div class="card">
                                    <a href="{{ Route('singlePage', ['id' => $article->id]) }}"><img
                                            class="card-img-top"
                                            src="{{ $article->image ? asset('article/images/' . $article->image) : asset('notFound.svg') }}"
                                            style=" height: 250px;" alt="Card image"></a>
                                    <div class="card-body">
                                        <h2 class="IRANSans_Bold" style="display: flex; justify-content: space-between; margin: 5px 0;"><a
